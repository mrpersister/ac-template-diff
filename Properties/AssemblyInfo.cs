...
namespace Access_control_diff
{
    ...
    internal abstract class AssemblyInfo
    {
        ...
        internal const string CompanyName = "Your Company";
        internal const string Copyright = "© Your Company. All rights reserved";
        internal const string Trademark = "";

        internal const string ProductName = "Access_control_diff integration to XProtect";
        internal const string ProductNameShort = "Access_control_diff";
        internal const string Description = "Access_control_diff integration";
